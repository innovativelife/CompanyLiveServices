...
public interface IEmployeeActions
{
    ...
    public Task<Tuple<DalResponse, List<Employee>>> Search(string tenantId, string? employeeNumber, string? email, string? firstName, string? lastName, string? leaderEmployeeNumber, string? employeeUID);
